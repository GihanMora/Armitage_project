...
def simplified_export(id_list):
    ...
    with open(dump_name, mode='w', encoding='utf8',
        ...
        attributes_a = ['_id', 'search_text', 'title', 'link', 'description', 'comp_name',
                        ...
                        'revenue','funding','headquarters','No_of_employees']
        results_writer.writerow(attributes_a)
        for entry_id in id_list:
            comp_data_entry = mycol.find({"_id": entry_id})
            data = [i for i in comp_data_entry]
            ...
            for each_a in attributes_a:
                try:
                    ...
                    if (each_a == 'funding'):
                        # print("***********f")
                        if ('funding_g' in attribute_keys):data_list.append(data[0]['funding_g'])  # from google
                        else:data_list.append("None")
...
def fix_100(id_list):
    ...
    for entry_id in id_list:
        ...
        # if 'founded' in each_tr[0]:
        #     print('founded',each_tr[1])
        #     results['founded_year_g']=each_tr[1]
        # if 'CEO' in each_tr[0]:
        #     print('CEO',each_tr[1])
        #     results['CEO_g'] = each_tr[1]
        # if 'revenue' in each_tr[0]:
        #     print('revenue',each_tr[1])
        #     results['revenue_g'] = each_tr[1]
        # if 'funding' in each_tr[0]:
        #     print('funding', each_tr[1])
        #     results['funding_g'] = each_tr[1]
        # if 'headquarters' in each_tr[0]:
        #     print('headquarters', each_tr[1])
        #     results['headquarters_g'] = each_tr[1]
        # if 'How many employees' in each_tr[0]:
        #     print('No of Employees', each_tr[1])
        #     results['no_of_employees_g'] = each_tr[1]
        # if 'competitors' in each_tr[0]:
        #     print('competitors', each_tr[1])
        #     results['competitors_g'] = each_tr[1]
        # if 'invested' in each_tr[0]:
        #     print('invested in', each_tr[1])
        #     results['invested_in_g'] = each_tr[1]
        # if 'sector' in each_tr[0]:
        #     print('sector ', each_tr[1])
        #     results['sector_g'] = each_tr[1]

# fix_100(ids_l[0:100])
# simplified_update(ids_l[2:100])
# simplified_export(ids_l[102:1200])
